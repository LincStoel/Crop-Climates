...
the scenarios already built (s1, s2, s3).
    ...
    python tools/stress/client_session.py
...
def main():
    s = Session()
    proc = subprocess.Popen(["cmd", "/c", "gradlew.bat", "runStressClient", "--console=plain"], cwd=str(ROOT),
